use bevy::prelude::*;
use bevy_ggrs::{PlayerInputs, Rollback, Session, RollbackFlag};
...
#[derive(Resource, Default, Reflect, Hash, Clone)]
#[reflect(Hash)]
...
pub fn move_cube_system(
    mut query: Query<(&mut Transform, &mut Velocity, &Player), With<RollbackFlag>>,
